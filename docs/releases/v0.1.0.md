DeskLore's first public source release turns macOS activity into a local, searchable,
multi-resolution timeline without continuously recording the screen.
...
- Local timeline with ten-minute, six-hour, and daily resolutions, plus search.
