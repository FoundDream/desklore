...
import { isAppLocale, translate } from "./index.js";
...
describe("app internationalization", () => {
  it("uses English as the default-facing copy and supports Simplified Chinese", () => {
    ...
    expect(translate("en", "timeline.periodCount", { count: 3 })).toBe("3 periods");
    expect(translate("zh-CN", "timeline.periodCount", { count: 3 })).toBe("3 段");
  });
