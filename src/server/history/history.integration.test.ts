...
import { classifyKeyboardEvent, EventBurstCoalescer, EventCoalescer } from "./events/coalescer.js";
import { decodeTimelineMarkdown, encodeTimelineMarkdown } from "./timeline/markdown.js";
import {
...
import { makeStorageLayout, SegmentStore, segmentIdentifier } from "./storage/repository.js";
import {
...
} from "./timeline/agent/runner.js";
import { TimelineAgentDiagnosticsRepository } from "./timeline/agent/diagnostics.js";
...
import { rawActivityRecord, TimelineRepository } from "./timeline/repository.js";
import {
...
describe("TypeScript history core", () => {
  ...
  it("keeps the synthetic prompt-injection corpus inside untrusted evidence boundaries", async () => {
    const corpus = JSON.parse(
      await readFile(new URL("./timeline/fixtures/timeline-safety.json", import.meta.url), "utf8"),
    ) as {
