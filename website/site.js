const translations = {
  en: {
    ...
    "privacy.inspectableTitle": "Timeline details and rollups are saved as Markdown.",
  ...
  "zh-CN": {
    ...
    "privacy.inspectableTitle": "时间线明细和聚合总结最终保存为 Markdown。",
    ...
    "flow.organizeBody": "生成可搜索的 Markdown 时间线，并提供十分钟、六小时和当天三种粒度。",
    "openSource.label": "开源",
